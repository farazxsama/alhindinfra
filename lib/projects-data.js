...
export const ongoingProjectsData = {
  ...
  "hilltop-1": {
    ...
    gallery: {
      ...
      videos: [
        {
          src: 'https://res.cloudinary.com/ctxkeudw/video/upload/v1785580060/hilltop1-video2_uvcitl.mp4',
          thumbnail: '/img/ongoing/hilltop-city-phase-1/hilltop1-site.jpg',
          alt: 'HillTop City Phase 1',
        },
      ],
      masterPlan: [
  ...
  "hilltop-3": {
    ...
    hero: {
      status: "Ongoing",
      description:
        "HillTop City Phase III is one of the latest residential projects launched by Al Hind Infra. It is located in the Shabad vicinity. The location is near the towns Shabad, Shamshabad, Shadnagar, Kothur, and Timmapur, which are 24 km south of Hyderabad",
      location: "Mariyapur Village, Shabad",
      // plotSize: "150–500 Sq. Yards",
      approval: "HMDA Approved",
      bannerImage:
    ...
    gallery: {
      ...
      videos: [
        {
          src: 'https://res.cloudinary.com/ctxkeudw/video/upload/v1785580579/hilltop3-video_eiyjko.mp4',
          thumbnail: '/img/ongoing/hill-city-phase-3/hilltop3-2.jpg',
          alt: 'Hilltop City Phase 3',
        },
      ],
      masterPlan: [
        { src: 'https://images.unsplash.com/photo-1628624747186-a941c476b7ef?q=80&w=1600&auto=format&fit=crop', alt: 'HillTop City Phase 1 master plan layout' },
  ...
  "global-city": {
    ...
    hero: {
      status: "Ongoing",
      description:
        "Al Hind Infra presents their latest project - Global City Phase 1. This brand-new project offers you attractive, highway-facing plots for sale. Global City Phase 1 is nestled within the same Shabad Mandal location as our recently completed projects: Prime City, Highway City, and Express City.",
    ...
    gallery: {
      ...
      videos: [
        {
          src: 'https://res.cloudinary.com/ctxkeudw/video/upload/v1785580614/global-city-video_qaladu.mp4',
          thumbnail: '/img/ongoing/global-city-phase-1/global-city-4.jpg',
          alt: 'Global City Phase 1',
        },
      ],
      masterPlan: [
        { src: 'https://images.unsplash.com/photo-1628624747186-a941c476b7ef?q=80&w=1600&auto=format&fit=crop', alt: 'HillTop City Phase 1 master plan layout' },
  ...
  "global-2": {
    ...
    hero: {
      status: "Ongoing",
      description:
        "Al Hind Infra India presents their latest project - Global City Phase 2. This brand-new project offers you attractive, highway-facing plots for sale. Global City Phase 2 is nestled within the same Shabad Mandal location as our recently completed projects: Global City, Prime City, Highway City, and Express City.",
    ...
    gallery: {
      ...
      videos: [
        {
          src: 'https://res.cloudinary.com/ctxkeudw/video/upload/v1785580658/global2-video2_lsvfx6.mp4',
          thumbnail: '/img/ongoing/global-city-phase-2/global2-site3.jpg',
          alt: 'Global City Phase 2',
        },
      ],
      masterPlan: [
        { src: 'https://images.unsplash.com/photo-1628624747186-a941c476b7ef?q=80&w=1600&auto=format&fit=crop', alt: 'HillTop City Phase 1 master plan layout' },
  ...
  "regional-city": {
    ...
    hero: {
      status: "Ongoing",
      description:
        "Regional City is a premium residential venture by Al Hind Infra, strategically located in Shabad Mandal near the upcoming Regional Ring Road (RRR). Spread across a well-planned gated community, it offers open plots starting at just Rs. 7,000/- per square yard.",
    ...
    gallery: {
      ...
      videos: [
        {
          src: 'https://res.cloudinary.com/ctxkeudw/video/upload/v1785580706/regional-video_eciou4.mp4',
          thumbnail: '/img/ongoing/regional-city/regional-boundary.jpg',
...
export const completedProjectsData = {
  ...
  "crystal-city": {
    ...
    hero: {
      status: "Completed",
      description:
        "Al Hind Infra proudly presents its latest venture 'Crystal City'. This brand-new project offers attractive open plots for sale, conveniently located adjacent to existing residential houses.",
      location: "Shabad Mandal, Near Shamshabad",
      // plotSize: "150–500 Sq. Yards",
      approval: "HMDA Approved",
      bannerImage:
    ...
    gallery: {
      ...
      videos: [
        {
          src: 'https://res.cloudinary.com/ctxkeudw/video/upload/v1785581552/crystal-city-video_atwfbv.mp4',
          thumbnail: '/img/completed/crystal-city/highway-city-new.jpg',
          alt: 'Crystal City',
        },
      ],
      masterPlan: [
  ...
  "hilton-city": {
    ...
    gallery: {
      ...
      videos: [
        {
          src: 'https://res.cloudinary.com/ctxkeudw/video/upload/v1785581577/hilton-city-video_jelu09.mp4',
          thumbnail: '/img/completed/hilton-city/hilton-city-5.jpg',
          alt: 'Hilton City',
        },
      ],
      masterPlan: [
  ...
  "express-city": {
    ...
    hero: {
      status: "Completed",
      description:
        "Al Hind Infra presents their latest project - Express City. This project offers you attractive, highway-facing residential plots for sale. Express city is nestled within the same Shabad Mandal location as our recently completed projects like Highway City, Falcon City and Pearl City.",
      location: "Shabad Mandal, Near Shamshabad",
      // plotSize: "150–500 Sq. Yards",
      approval: "HMDA Approved",
      bannerImage:
  ...
  "highway-phase-2": {
    ...
    hero: {
      status: "Completed",
      description:
        "Al Hind Infra India' presents their latest project - 'Highway City Phase 2'. This brand new project offers you attractive, highway-facing plots for sale. Highway city Phase 2 is nestled within the same Shabad Mandal location as our recently completed projects: Silver City, Highway City, Royal City (HMDA), and Pearl City.",
      location: "Shabad Mandal, Near Shamshabad",
      // plotSize: "150–500 Sq. Yards",
      approval: "HMDA Approved",
      bannerImage:
  ...
  "pearl-city": {
    ...
    hero: {
      status: "Completed",
      description:
        "Al Hind Infra India brings to you their latest project - Pearl City",
      location: "Shabad Mandal, Near Shamshabad",
      // plotSize: "150–500 Sq. Yards",
      approval: "HMDA Approved",
      bannerImage:
  ...
  "peace-city": {
    ...
    about: {
      paragraphs: [
        "Looking for a Gated Community plot with a fantastic future? Concerned about investment safety? Peace City by Al Hind Infra is the perfect solution for you! We proudly present residential plots for sale near Shamshabad, ideal for villas, apartment buildings, or farmhouses. Located in a residential free zone, this gated community offers excellent connectivity just 25 minutes from Shamshabad International Airport and only 2 minutes from Shabad.",
    ...
    gallery: {
      ...
      videos: [
        {
          src: 'https://res.cloudinary.com/ctxkeudw/video/upload/v1785581609/peace-city-video_b5nduh.mp4',
          thumbnail: '/img/completed/peace-city/peace-city-1.jpg',
          alt: 'Peace City',
        },
      ],
      masterPlan: [
  ...
  "prime-city": {
    ...
    hero: {
      status: "Completed",
      description:
        "Al Hind Infra India presents their latest project - Prime City. This brand-new project offers you attractive, highway-facing residential plots for sale. Prime city is nestled within the same Shabad Mandal location as our recently completed projects: Highway City and Express City",
      location: "Shabad Mandal, Near Shamshabad",
      // plotSize: "150–500 Sq. Yards",
      approval: "HMDA Approved",
      bannerImage:
    ...
    gallery: {
      ...
      videos: [
        {
          src: 'https://res.cloudinary.com/ctxkeudw/video/upload/v1785581644/prime-city-video_wjjyje.mp4',
          thumbnail: '/img/completed/prime-city-phase-1-2/prime-city-2',
          alt: 'Prime City',
        },
      ],
      masterPlan: [
  ...
  "dream-home": {
    ...
    hero: {
      status: "Completed",
      description:
        "Al Hind Infra presents their latest project - Dream Home City. This brand-new project offers you attractive, highway-facing residential plots. Dream Home is nestled in Hayatabad area within the same Shabad Mandal",
      location: "Shabad Mandal, Near Shamshabad",
      // plotSize: "150–500 Sq. Yards",
      approval: "HMDA Approved",
      bannerImage:
  ...
  "regional-city": {
    ...
    gallery: {
      ...
      videos: [
        {
          src: 'https://res.cloudinary.com/ctxkeudw/video/upload/v1785581688/regional-video_rcbuoc.mp4',
          thumbnail: '/img/completed/regional-city/regional-boundary.jpg',
          alt: 'Regional City',
        },
      ],
      masterPlan: [
  ...
  "natural-city": {
    ...
    hero: {
      status: "Completed",
      description:
        "Natural City is one of the latest projects launched by Al Hind Infra. It is located in the Shabad Mandal vicinity and close to Upcoming Regional Ring Road (RRR)",
      location: "Shabad Mandal, Near Shamshabad",
      // plotSize: "150–500 Sq. Yards",
      approval: "HMDA Approved",
      bannerImage:
  ...
  "falcon-phase-4": {
    ...
    gallery: {
      ...
      videos: [
        {
          src: 'https://res.cloudinary.com/ctxkeudw/video/upload/v1785581721/Falcon_City_gskgym.mp4',
          thumbnail: '/img/completed/falcon-city-phase-4/falcon-city-1.jpg',
          alt: 'Falcon Phase 4',
        },
      ],
      masterPlan: [
